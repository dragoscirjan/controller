...
import {ResponseBodyEncoder} from '@glasswing/http'
import {ControllerAction, wrapPropertyDescriptorHandler} from './_utils'
 ...
 */
export const RespondWith = (bodyEncoder: ResponseBodyEncoder = (data: any) => data, ...other: any[]): MethodDecorator => (
  target: any,
